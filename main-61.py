...
PATCH_VERSION = "v34.6-engines-menu-clean-2026-07-07"
...
def _modes_root_text() -> str:
    return (
        ...
        "• 🧠 Движки — отдельный список всех подключённых нейросетей и провайдеров\n"
...
def photo_quick_actions_kb():
    ...
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🧽 Ретушь / надпись", callback_data="pedit:retouch")],
