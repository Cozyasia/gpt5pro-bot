...
PATCH_VERSION = "v33.5.2-bg-local-first-2026-07-05"
...
with contextlib.suppress(Exception):
    ...
    os.makedirs(os.environ.get("XDG_CACHE_HOME", "/data/.cache"), exist_ok=True)
_REMBG_SESSION = None
...
async def cmd_diag_bg(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    lines.append(f"LOCAL_REMBG_ENABLED={LOCAL_REMBG_ENABLED}")
