...
PATCH_VERSION = "revive-fix-v21-NO-INLINE-REGEX-2026-05-23"
...
def _mode_desc(key: str) -> str:
    ...
    if key == "fun":
        return (
            ...
            "Sora 2/Kling (короткие видео), Runway/Sora/Kling (оживление фото), STT/TTS (голос и озвучка).\n\n"
...
async def cmd_diag_video(update: Update, context: ContextTypes.DEFAULT_TYPE):
    lines = [
        ...
        f"• Нормализация duration: Kling 5 или 10 сек; Sora 4/8/12 сек; Runway только image→video; Luma временно скрыта",
