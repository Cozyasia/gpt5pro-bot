...
PATCH_VERSION = "v35.1-workbusiness-suno-2026-07-08"
...
async def on_mode_cb(update, context):
    ...
    if data == "act:fun:music":
        ...
        await q.edit_message_text(_suno_help_text(), parse_mode="Markdown", reply_markup=_mode_kb("fun"))
        return
...
async def cmd_music(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not brief:
        context.user_data["awaiting_suno_brief"] = True
        await update.effective_message.reply_text(_suno_help_text(), parse_mode="Markdown", reply_markup=main_kb)
        return
...
async def on_cb_fun(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "music":
        ...
        await q.edit_message_text(_suno_help_text(), parse_mode="Markdown", reply_markup=_fun_quick_kb())
        return
