...
class CelebritySelfieV157Tests(unittest.TestCase):
    ...
    def test_v157_remains_an_implementation_library_under_v162(self):
        ...
        hotfix161 = _source("neyrobot_prod/hotfix_v161.py")
        hotfix162 = _source("neyrobot_prod/hotfix_v162.py")
