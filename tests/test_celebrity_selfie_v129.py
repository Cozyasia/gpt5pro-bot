...
class CelebritySelfieV129Tests(unittest.TestCase):
    ...
    def test_v129_is_historical_and_v135_is_registered(self):
        self.assertNotIn("from celebrity_selfie_v129 import install_builder_hook", self.bootstrap)
        self.assertIn("from celebrity_selfie_v135 import install_builder_hook", self.bootstrap)
        for version in ("v122", "v123", "v123_pedit", "v124", "v125", "v126", "v127", "v128", "v130_runtime", "v131", "v132", "v133", "v134"):
