...
class V251V2IdentityDetailTests(unittest.TestCase):
    ...
    def test_v251_owner_accepts_v252_final_quality_overlay(self) -> None:
        ...
        # V251 remains the proven callback/UX owner. V252 is deliberately only the
        # final provider-quality overlay, so runtime bindings should point to V252
        # while all V251/V247 geometry and delivery contracts remain unchanged.
        v252.enforce_runtime(bind_generate=True)
        ...
        self.assertIs(transfer._true_face_transfer, v252._true_face_transfer_with_v252_label)
