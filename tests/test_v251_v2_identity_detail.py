...
class V251V2IdentityDetailTests(unittest.TestCase):
    ...
    def test_v251_restores_supersample_face_local_and_provider(self) -> None:
        ...
        v251.enforce_runtime(bind_generate=True)
        ...
        self.assertIs(transfer._true_face_transfer, v251._true_face_transfer_with_v251_label)
        runtime = v241._runtime()
        if runtime is not None:
            self.assertIs(runtime._segmind_faceswap_v2, v251._segmind_v2_verified_detail)
