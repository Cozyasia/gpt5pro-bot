...
PATCH_VERSION = "v57-comet-ai-selfie-fix-avatar-voice-2026-07-09"
...
async def on_mode_cb(update, context):
    ...
    if data.startswith("act:fun:av_voice_"):
        ...
        await q.message.reply_text(f"✅ Для аватара выбран голос: {_avatar_tts_voice_label(voice)}. Теперь пришлите текст или выберите «Текст → говорящий аватар».")
        return
