...
PATCH_VERSION = "v48-comet-replicate-bg-remove-2026-06-03"
...
COMET_BG_REMOVE_PATHS = _env_list(
    ...
    f"{COMET_BG_REPLICATE_PATH},/v1/responses,/bria/image/edit/remove-background,/bria/image/edit/remove_background"
)
...
def _comet_bg_request_candidates(img_bytes: bytes, image_url: str = "") -> list[tuple[str, dict]]:
    ...
    for path in COMET_BG_REMOVE_PATHS:
        if path in {"/v1/responses"} or "/replicate/v1/models/" in path or path.endswith("/remove-bg"):
            continue
