...
PATCH_VERSION = "v34.5-readable-buttons-2026-07-07"
...
def engines_kb():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("💬 GPT: текст/фото/доки", callback_data="engine:gpt")],
        [InlineKeyboardButton("🖼 OpenAI Images",             callback_data="engine:images")],
        [InlineKeyboardButton("🎥 Runway: оживить фото",      callback_data="engine:runway")],
        [InlineKeyboardButton("🎞 Sora 2: фото/текст→видео",    callback_data="engine:sora")],
        [InlineKeyboardButton("🎬 Kling: фото/текст→видео",     callback_data="engine:kling")],
        [InlineKeyboardButton("🎨 Midjourney: картинки",    callback_data="engine:midjourney")],
        [InlineKeyboardButton("🗣 Речь ↔ текст",        callback_data="engine:stt_tts")],
    ])
