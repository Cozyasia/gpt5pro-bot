...
PATCH_VERSION = "v35.5-free-quota-faceswap-reset-suno-clean-2026-07-08"
...
START_TEXT = (
    ...
    "• 🔥 *Развлечения* — оживление фото, Reels/Shorts, мини-фильмы, сценарии, замена лица, удаление/замена фона, ретушь, удаление водяных знаков и музыка Suno.\n"
