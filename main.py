...
PATCH_VERSION = "v90-image-engine-choice-2026-07-13"
...
def _image_engine_choice_kb(aid: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([
        [InlineKeyboardButton(f"✨ Авто · {_image_engine_price_label('openai')}", callback_data=f"chooseimg:auto:{aid}")],
...
async def _ask_image_engine_choice(update: Update, context: ContextTypes.DEFAULT_TYPE, prompt: str):
    ...
    await update.effective_message.reply_text(msg, reply_markup=_image_engine_choice_kb(aid))
