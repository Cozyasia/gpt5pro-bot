...
PATCH_VERSION = "revive-med-v8-2026-05-22"
...
async def _run_comet_i2v(update: Update, context: ContextTypes.DEFAULT_TYPE, engine: str, img_bytes: bytes, prompt: str, duration_s: int, aspect: str):
    ...
    if engine == "sora":
        ...
        # Пробуем несколько совместимых схем: image_urls, image_url и input_reference.
        payloads = []
        ...
        # 3) Вариант в стиле OpenAI Videos API JSON input_reference.
        payloads.append((
            SORA_CREATE_PATH,
            {
                "model": SORA_MODEL,
            ...
            payloads.extend([
                ...
                (
                    SORA_CREATE_PATH,
                    {
                        "model": SORA_MODEL,
                        "prompt": prompt,
                        "input_reference": {"image_url": tg_url},
                        "duration": d,
                    },
                ),
            ])
