...
PATCH_VERSION = "revive-fun-med-v13-sora-multipart-2026-05-22"
...
def capability_answer(text: str) -> str | None:
    ...
    if (
        ...
        return (
            ...
            "После этого я предложу выбрать доступный движок (Runway, Sora 2 или Kling)."
        )
        ...
        if data.startswith("engine:"):
            ...
            if engine in ("gpt", "stt_tts", "midjourney"):
                await q.edit_message_text(
                    ...
                    f"Для Runway/Images действуют дневные бюджеты тарифа."
                )
                return
