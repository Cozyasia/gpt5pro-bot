...
PATCH_VERSION = "v54-full-v35.6-plus-avatar-photoclip-menu-2026-07-09"
...
def _free_quota_category(engine: str, remember_kind: str = "") -> str:
    ...
    if rk.startswith(("faceswap", "face_swap")) or rk in (
        "image_retouch", "removebg", "replacebg", "outpaint", "photo_processing",
