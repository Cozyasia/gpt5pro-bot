...
PATCH_VERSION = "v62-fast-background-photo-clip-2026-07-09"
...
async def _start_photo_music_clip(update: Update, context: ContextTypes.DEFAULT_TYPE, img_bytes: bytes, user_prompt: str):
    ...
    async def _photo_clip_job():
        ...
        try:
            ...
            await update.effective_message.reply_text("🎧 Музыка получена. Собираю один итоговый MP4…")
            ...
            if not final_bytes:
                raise RuntimeError("не удалось собрать итоговый MP4 с музыкой")
