...
PATCH_VERSION = "v41-menu-safe-edit-reels-actions-2026-05-28"
...
def _docs_menu_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🌍 Перевод", callback_data="act:free"), InlineKeyboardButton("📊 PDF/Презент.", callback_data="biz:presentation")],
...
def _business_menu_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("📊 Презентация", callback_data="biz:presentation"), InlineKeyboardButton("💰 ROI", callback_data="biz:roi")],
        [InlineKeyboardButton("📲 WhatsApp", callback_data="biz:whatsapp"), InlineKeyboardButton("🌍 Перевод", callback_data="biz:translate")],
...
async def on_nav_cb(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if data.startswith("creative:manual_video:"):
            ...
            candidates = ("runway", "kling", "kling_multi", "seedance", "veo", "hailuo", "vidu", "grok", "sora") if has_images else ("kling", "seedance", "veo", "hailuo", "vidu", "grok", "sora")
