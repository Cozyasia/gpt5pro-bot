...
PATCH_VERSION = "v78-tariffs-credits-marketing-2026-07-12"
...
SUBS_TIERS = {
    "start": {
        ...
        "features": [
            "💬 GPT-чат, документы и переводчик: базовые лимиты",
            "🖼 Фото-мастерская и картинки — через кредиты",
            "🎧 Озвучка ответов и распознавание речи",
            f"🪙 {SUBSCRIPTION_CREDITS.get('start', 20)} кредитов на платные функции в месяц",
        ],
    },
    "pro": {
        "title": "PRO",
        ...
        "features": [
            "📚 Глубокий разбор PDF/DOCX/EPUB и учебные сценарии",
            "🎬 Reels/Shorts, фото→видео, Suno и AI-фото — через кредиты",
            "🖼 Outpaint, фон, FaceSwap, AI-селфи",
            f"🪙 {SUBSCRIPTION_CREDITS.get('pro', 120)} кредитов на платные функции в месяц",
        ],
    },
    "ultimate": {
        "title": "ULTIMATE",
        ...
        "features": [
            "🚀 Runway / Kling / Sora 2 — премиум-рендеры через кредиты",
            "🧠 Максимальные GPT-лимиты и приоритетная очередь",
            "🎤 Клип с вокалом, говорящий аватар, видео по тексту/голосу",
            f"🪙 {SUBSCRIPTION_CREDITS.get('ultimate', 350)} кредитов на платные функции в месяц",
        ],
    },
}
