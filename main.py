...
self.wfile.write(b"<h3>Premium page</h3><p>Set WEBAPP_URL env.</p>")
...
if data.startswith("choose:"): # choose::
...
await update.effective_message.reply_text("Формат: /set_welcome ")
