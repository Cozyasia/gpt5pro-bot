...
def _telegram_file_url_from_file(tg_file):
    """Build a public Telegram file URL.

    NOTE: Some library versions may return `file_path` already as a full URL.
    In that case we must NOT prepend the base again, otherwise we get:
    https://api.telegram.org/file/botTOKEN/https://api.telegram.org/file/botTOKEN/...
    """
