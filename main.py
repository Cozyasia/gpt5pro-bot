...
PATCH_VERSION = "v81-yookassa-api-ready-2026-07-12"
...
def _plans_overview_text(user_id: int) -> str:
    parts = [
        "⭐ Подписка и тарифы",
        "Все тарифы открывают доступ к AI-функциям Neyro-Bot GPT 5 Studio. Кредиты используются для тяжёлых генераций: видео, музыка, аватары, премиум-фото, FaceSwap, Runway, Kling, Sora 2 и Suno. Чем выше тариф — тем больше кредитов, выше GPT-лимиты и быстрее очередь.",
