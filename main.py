...
PATCH_VERSION = "revive-fix-v5-2026-05-22"
...
KLING_STATUS_PATH = os.environ.get("KLING_STATUS_PATH", "/kling/v1/videos/{id}").strip() or "/kling/v1/videos/{id}"
...
async def _run_comet_i2v(update: Update, context: ContextTypes.DEFAULT_TYPE, engine: str, img_bytes: bytes, prompt: str, duration_s: int, aspect: str):
    ...
    if engine == "sora":
        ...
        await _create_and_poll_i2v(
            ...
            SORA_API_KEY,
            payloads,
            [SORA_STATUS_PATH, "/v1/tasks/{id}", "/v1/videos/{id}"],
            "Sora 2 image→video",
        )
        return
    ...
    if engine == "kling":
        ...
        await _create_and_poll_i2v(
            ...
            KLING_API_KEY,
            payloads,
            [KLING_STATUS_PATH, "/kling/v1/videos/{id}", "/v1/tasks/{id}", "/v1/videos/{id}"],
            "Kling image→video",
        )
        return
