...
# ───────── UI / тексты ─────────
START_TEXT = (
    "Привет! Я **Нейро ProBot** — ⚡️ мультирежимный бот из **7 нейросетей** "
    "для 🎓 учёбы, 💼 работы и 🔥 развлечений. Я умею работать **гибридно**: "
    "могу сам выбрать лучший движок под задачу или дать тебе выбрать вручную.\n\n"
    ...
    "  названия/описания листов, сводные таблицы из текстов, оформление пояснительных записок. 🛠️📊\n"
    "• 🔥 **Развлечения** — фото-мастерская (удаление/замена фона, дорисовка, outpaint), оживление старых фото, "
    "  видео по тексту/голосу, идеи и форматы для Reels/Shorts, авто-нарезка из длинных видео (сценарий/тайм-коды), "
    "  мемы/квизы. 🎥🖼️🪄\n\n"

    "🧭 **Как пользоваться**: выбери режим кнопкой ниже **или просто напиши запрос** — я сам определю задачу и предложу варианты.\n"
    "🧠 Кнопка **«Движки»** — для точного выбора, **какую нейросеть** использовать принудительно.\n"
)
