...
LIMITS = {
    ...
    "start":     {"text_per_day": 200,  "luma_budget_usd": 0.8,  "runway_budget_usd": 0.0,  "img_budget_usd": 0.2,  "allow_engines": ["gpt","luma","midjourney","images","sora","suno","stt_tts"]},
    "pro":       {"text_per_day": 1000, "luma_budget_usd": 4.0,  "runway_budget_usd": 7.0,  "img_budget_usd": 1.0,  "allow_engines": ["gpt","luma","runway","midjourney","images","sora","suno","stt_tts"]},
    "ultimate":  {"text_per_day": 5000, "luma_budget_usd": 8.0,  "runway_budget_usd": 14.0, "img_budget_usd": 2.0,  "allow_engines": ["gpt","luma","runway","midjourney","images","sora","suno","stt_tts"]},
}
...
async def on_text(
    ...
    if selected_engine in ("luma", "runway"):
        ...
        est = 0.40 if selected_engine == "luma" else max(
            1.0,
