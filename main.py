...
PATCH_VERSION = "ui-sync-v24-SEVEN-ENGINES-WEBAPP-2026-05-23"
...
# ───────── UI / тексты ─────────
START_TEXT = (
    "Привет! Я Нейро-Bot — ⚡️ мультирежимный бот из 7 нейросетей/движков для 🎓 учёбы, 💼 работы, 🔥 развлечений и 🩺 медицины.\n"
    "Единая картина по текущей версии: GPT-5, Images, Runway, Sora 2, Kling, Midjourney и Deepgram/STT/TTS. Luma временно скрыта и не используется.\n"
    ...
    "🎬 Видео по тексту/голосу создаём через Sora 2 или Kling. Runway оставлен только для оживления фото.\n"
    "📸 Для людей: Runway/Kling. Sora 2 — только фото без людей: предметы, животные, здания, интерьер, пейзажи.\n"
    "\n"
    "🧭 Как пользоваться:\n"
...
def engines_kb():
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🎞 Sora 2 — video / без людей",   callback_data="engine:sora")],
...
async def on_capabilities_qa(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    msg = (
        ...
        "• ✨ Оживление фото: загрузи фото — можно выбрать Runway, Kling или Sora 2 без людей.\n"
