...
# Allowed aspect ratios for video generation (used by parse_video_opts)
...
COMET_BASE_URL   = (os.environ.get("COMET_BASE_URL")
                    or os.environ.get("COMET_API_BASE")
                    or os.environ.get("COMETAPI_BASE")
                    or os.environ.get("COMETAPI_BASE_URL")
                    or "https://cometapi.com").strip().rstrip("/")
COMET_API_KEY    = (os.environ.get("COMET_API_KEY")
                    or os.environ.get("COMETAPI_KEY")
                    or os.environ.get("COMETAPIKEY")
                    or "").strip()
