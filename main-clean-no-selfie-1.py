...
def _modes_root_text() -> str:
    return (
        ...
        "• 🔥 Развлечения — фото, видео, Reels/Shorts, мини-фильмы, фон, замена лица, вокальные клипы и музыка.\n"
...
def _find_first_image_b64(obj) -> bytes | None:
    if isinstance(obj, dict):
        # Image APIs may return nested inline image data.
